...
lib.ssMetadata = [
		{name:"PR_IdeaPad_Slim_5x_CM_GDN_728x90_atlas_1", frames: [[738,179,50,50],[0,0,728,90],[357,368,298,90],[657,368,293,90],[730,0,244,90],[0,276,374,90],[0,92,728,90],[376,276,360,90],[730,92,235,85],[0,368,355,90],[0,184,728,90]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["PR_IdeaPad_Slim_5x_CM_GDN_728x90_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.PRIdeaPadSlim5xCMGDN728x90 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	// Frame9
	this.instance = new lib.Frame9();
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(400).to({_off:false},0).wait(50));

	// Frame8
	this.instance_1 = new lib.Frame8();
	this.instance_1.setTransform(141,0);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(350).to({_off:false},0).to({_off:true},50).wait(50));

	// Frame7
	this.instance_2 = new lib.Frame7();
	this.instance_2.setTransform(231,2);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(300).to({_off:false},0).to({_off:true},50).wait(100));

	// Frame6
	this.instance_3 = new lib.Frame6();
	this.instance_3.setTransform(128,0);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(250).to({_off:false},0).to({_off:true},50).wait(150));

	// Frame5
	this.instance_4 = new lib.frame5728x90();
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(200).to({_off:false},0).to({_off:true},50).wait(200));

	// Frame4
	this.instance_5 = new lib.Frame4();
	this.instance_5.setTransform(117,0);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(151).to({_off:false},0).to({_off:true},49).wait(250));

	// Frame3
	this.instance_6 = new lib.Frame3();
	this.instance_6.setTransform(212,0);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(101).to({_off:false},0).to({_off:true},50).wait(299));

	// Frame2
	this.instance_7 = new lib.Frame2();
	this.instance_7.setTransform(198,0);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(50).to({_off:false},0).to({_off:true},51).wait(349));

	// Frame1
	this.instance_8 = new lib.Frame1();
	this.instance_8.setTransform(205,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({_off:true},50).wait(400));
...
// library properties:
lib.properties = {
	id: '5160618579363D4A8CD3FD3F630F2AFA',
	width: 728,
	height: 90,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/PR_IdeaPad_Slim_5x_CM_GDN_728x90_atlas_1.png", id:"PR_IdeaPad_Slim_5x_CM_GDN_728x90_atlas_1"}
	],
	preloads: []
};
...
an.compositions['5160618579363D4A8CD3FD3F630F2AFA'] = {
